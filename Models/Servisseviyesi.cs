...
public partial class Servisseviyesi
{
    ...
    public string? CariOzelalan1 { get; set; }

    public string? CariOzelalan2 { get; set; }

    public string? CariOzelalan3 { get; set; }

    public string? CariOzelalan4 { get; set; }

    public string? CariOzelalan5 { get; set; }
